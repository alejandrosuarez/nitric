...
// Validate checks the field values on JwtSigningConfig with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *JwtSigningConfig) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on JwtSigningConfig with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// JwtSigningConfigMultiError, or nil if none found.
func (m *JwtSigningConfig) ValidateAll() error {
	return m.validate(true)
}

func (m *JwtSigningConfig) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	case *JwtSigningConfig_JwksUri:
		// no validation rules for JwksUri

	}

	if len(errors) > 0 {
		return JwtSigningConfigMultiError(errors)
	}

	return nil
}

// JwtSigningConfigMultiError is an error wrapping multiple validation errors
// returned by JwtSigningConfig.ValidateAll() if the designated constraints
// aren't met.
type JwtSigningConfigMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m JwtSigningConfigMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m JwtSigningConfigMultiError) AllErrors() []error { return m }

// JwtSigningConfigValidationError is the validation error returned by
// JwtSigningConfig.Validate if the designated constraints aren't met.
type JwtSigningConfigValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e JwtSigningConfigValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e JwtSigningConfigValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e JwtSigningConfigValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e JwtSigningConfigValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e JwtSigningConfigValidationError) ErrorName() string { return "JwtSigningConfigValidationError" }

// Error satisfies the builtin error interface
func (e JwtSigningConfigValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sJwtSigningConfig.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = JwtSigningConfigValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = JwtSigningConfigValidationError{}
...
func (m *ApiSecurityDefinitionJwt) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetSigningConfig()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ApiSecurityDefinitionJwtValidationError{
					field:  "SigningConfig",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	} else if v, ok := interface{}(m.GetSigningConfig()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
